...
class ReferenceEncoder(nn.Module):
    ...
    def __init__(self):
        ...
        out_channels = self.calculate_channels(hparams.ref_enc_n_mels, 3, 2, 1, K)
    ...
    def forward(self, inputs):
        N = inputs.size(0)
        out = inputs.view(N, 1, -1, hparams.ref_enc_n_mels)  # [N, 1, Ty, n_mels]
...
class STL(nn.Module):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.embed = nn.Parameter(torch.FloatTensor(hparams.token_num, hparams.E //hparams.num_heads))
        d_q = hparams.E // 2
